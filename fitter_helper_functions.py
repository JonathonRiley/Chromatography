...
from helper_functions import expo_gauss_curve, multi_expo_gauss_curve, find_asym
...
def process_guess_and_bounds(guess_path):
    guesses = load_fit_guess(guess_path)
